...
| ID        | Requirement                                                                                                                                                                                                                                                                                                                                                                                                                 | Reference | Dependency |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ---------- |
| FR-TST-01 | The test framework MUST organize tests into test suites represented by classes inheriting from a generic test-suite base class.                                                                                                                                                                                                                                                                                             |           |            |
| FR-TST-02 | A Lua file whose name begins with `test` and which returns a class inheriting from the generic test-suite base class MUST be recognized as a test suite.                                                                                                                                                                                                                                                                    |           |            |
| FR-TST-03 | Each discovered test file MUST contain exactly one test suite.                                                                                                                                                                                                                                                                                                                                                              |           |            |
| FR-TST-04 | Test cases MUST be discovered automatically from test-suite methods whose names begin with `test`. No explicit test registration or decorator mechanism is required.                                                                                                                                                                                                                                                        |           |            |
| FR-TST-05 | Each test suite MUST execute using a fresh test-suite instance. Class members MAY be used as shared fixture state for the test cases in that suite.                                                                                                                                                                                                                                                                         |           |            |
| FR-TST-06 | `setup()` MUST be executed before every test case in the suite.                                                                                                                                                                                                                                                                                                                                                             |           |            |
| FR-TST-07 | `teardown()` MUST be executed after every test case in the suite.                                                                                                                                                                                                                                                                                                                                                           |           |            |
| FR-TST-08 | `suiteSetup()` MUST be executed before the first test case of the suite.                                                                                                                                                                                                                                                                                                                                                    |           |            |
| FR-TST-09 | `suiteTeardown()` MUST be executed after the last test case of the suite.                                                                                                                                                                                                                                                                                                                                                   |           |            |
| FR-TST-10 | The test runner MUST provide environment setup and environment teardown around the complete test execution.                                                                                                                                                                                                                                                                                                                 |           |            |
| FR-TST-11 | A `setup()` failure MUST fail its test case and prevent that test method from executing. A `teardown()` failure MUST fail its test case even if the test method passed. A `suiteSetup()` failure MUST cause all test cases in the affected suite to fail/cannot execute, while allowing the runner to continue with the next suite. A `suiteTeardown()` failure MUST cause the suite to fail even if all test cases passed. |           |            |
| FR-TST-12 | Test methods, lifecycle methods, and runner operations MUST be executed using protected calls so that failures do not terminate the complete test run.                                                                                                                                                                                                                                                                      |           |            |
| FR-TST-13 | The framework MUST provide `assertTrue`, `assertFalse`, `assertEquals`, `assertNotEquals`, `assertNil`, `assertThrows`, `assertDeepEquals`, and `assertDelta`.                                                                                                                                                                                                                                                              |           |            |
| FR-TST-14 | Test suites and test cases MUST execute in alphabetical order by default.                                                                                                                                                                                                                                                                                                                                                   |           |            |
| FR-TST-15 | The test runner MUST support an optional shuffle mode that randomizes test execution order.                                                                                                                                                                                                                                                                                                                                 |           |            |
| FR-TST-16 | A shuffled test run MUST use and report an explicit seed so that the exact execution order of a failed randomized run can be reproduced.                                                                                                                                                                                                                                                                                    |           |            |
| FR-TST-17 | The test framework MUST provide a mechanism to register callbacks/listeners for environment, suite, and test-case lifecycle events.                                                                                                                                                                                                                                                                                         |           |            |
| FR-TST-18 | Failures in test listeners MUST be isolated and MUST NOT terminate or otherwise invalidate the test execution itself.                                                                                                                                                                                                                                                                                                       |           |            |
| FR-TST-19 | A test method whose name begins with `DISABLED_` MUST be reported as `SKIPPED` and MUST NOT be executed.                                                                                                                                                                                                                                                                                                                    |           |            |
| FR-TST-20 | A test suite whose name begins with `DISABLED_` MUST be reported as skipped and its test cases MUST NOT be executed.                                                                                                                                                                                                                                                                                                        |           |            |
| FR-TST-21 | Every test case MUST result in exactly one of `PASS`, `FAIL`, or `SKIPPED`.                                                                                                                                                                                                                                                                                                                                                 |           |            |
| FR-TST-22 | A failed test case MUST report the project, test suite, test case, and reason for failure.                                                                                                                                                                                                                                                                                                                                  |           |            |
| FR-TST-23 | The test runner MUST report test results during execution and MUST provide a final summary containing counts of passed, failed, and skipped tests.                                                                                                                                                                                                                                                                          |           |            |
| FR-TST-24 | The build system MUST provide a repository-level test runner capable of discovering and executing test-enabled projects.                                                                                                                                                                                                                                                                                                    |           |            |
| FR-TST-25 | The repository-level test runner MUST support selecting projects using the same build-group concept used for repository/project build selection.                                                                                                                                                                                                                                                                            |           |            |
| FR-TST-26 | Each project MUST be executed using a fresh test-runner instance so that project-level test state does not leak between projects.                                                                                                                                                                                                                                                                                           |           |            |
| FR-TST-27 | If any test case in a suite fails, the complete suite MUST be considered failed.                                                                                                                                                                                                                                                                                                                                            |           |            |
| FR-TST-28 | If any suite in a project fails, the complete project MUST be considered failed.                                                                                                                                                                                                                                                                                                                                            |           |            |
| FR-TST-29 | If any project fails, the complete repository-level test run MUST be considered failed.                                                                                                                                                                                                                                                                                                                                     |           |            |
| FR-TST-30 | The repository-level test runner MUST continue executing other suites and projects after failures whenever they can still be executed.                                                                                                                                                                                                                                                                                      |           |            |
| FR-TST-31 | The repository-level test runner MUST report results for each project and then provide an overall repository result.                                                                                                                                                                                                                                                                                                        |           |            |
| FR-TST-32 | The test build type MUST execute in the development environment rather than inside a ComputerCraft runtime.                                                                                                                                                                                                                                                                                                                 |           |            |
| FR-TST-33 | ComputerCraft APIs used by tests MUST be mocked or replaced by the test developer when required.                                                                                                                                                                                                                                                                                                                            |           |            |
| FR-TST-34 | The test system MUST NOT require or prescribe a specific ComputerCraft API mocking framework.                                                                                                                                                                                                                                                                                                                               |           |            |
| FR-TST-35 | Test artifacts MUST preserve the complete module structure and MUST NOT be bundled or minified so that source file names and line numbers remain meaningful.                                                                                                                                                                                                                                                                |           |            |
| FR-TST-36 | Test suites MUST be isolated from one another through fresh suite fixture instances.                                                                                                                                                                                                                                                                                                                                        |           |            |
| FR-TST-37 | The test framework MUST NOT be responsible for isolating system resources such as the filesystem. Such isolation is the responsibility of the test developer.                                                                                                                                                                                                                                                               |           |            |
| FR-TST-28 | The test framework MUST provide deterministic execution by default and MUST provide sufficient information to reproduce randomized execution.                                                                                                                                                                                                                                                                               |           |            |
